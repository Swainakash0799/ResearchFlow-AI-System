...
# ── Page config ──────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="ResearchFlow AI · AI Research Agent",
    page_icon="🔬",
    layout="wide",
...
<div class="hero">
    ...
    <h1>Research<span>Flow AI</span></h1>
    <p class="hero-sub">
...
st.markdown("""
<div class="notice">
    ResearchFlow AI · Powered by LangChain multi-agent pipeline · Built with Streamlit
</div>
""", unsafe_allow_html=True)